...
The large change in p value magnitude from 9 to 10, and 9 pcs being around an inflection point in the elbow plot went into our picking PCs1-9 for tSNE and clustering.
...
```{r}
age.clust <- factor(Tcells$RNA_snn_res.0.1, labels = c("adult-cluster", "UCB-cluster", "fetal-cluster"))
